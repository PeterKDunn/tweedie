SUBROUTINE twpdf(N, p, phi, y, mu, verbose, exact, funvalue, exitstatus, relerr, its) BIND(C, name="twpdf")
  ...
  CALL twpdf_main(N, p, phi, y, mu, verbose, exact, funvalue, exitstatus, relerr, its)
