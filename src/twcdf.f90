SUBROUTINE twcdf(N, p, phi, y, mu, verbose, funvalue, exitstatus, relerr, its) BIND(C, name="twcdf")
  ...
  CALL twcdf_main(N, p, phi, y, mu, verbose, funvalue, exitstatus, relerr, its)
