...
This package uses fast numerical algorithms (infinite oscillating integrals; infinite series) to evaluate the Tweedie density functions and distribution functions.
